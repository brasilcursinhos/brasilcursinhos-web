...
// Importe a server action criada no passo anterior
...
export default function Contato() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      console.error("Erro ao processar o envio:", result.error);
    }
  };
      ...
      <div className="w-full lg:w-1/2 max-w-lg">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button 
            ...
            className="bg-[#109DAD] text-[#FFFFFF] px-6 py-3 rounded-xl text-sm font-semibold cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
